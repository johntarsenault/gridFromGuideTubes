function gridInfo = makeGridImage(imageLocation, imageOrient, guideTube, gridpos)
...
guideTubeMask.vol = reorientVol(guideTubeMask.vol, imageOrient.dimOrder, imageOrient.isFlipped);
...
[guideTube_2D_indices, guideTube_3D_indices] = findGuideTubeIndices(guideTubeMask, anat, guideTube.threshold, guideTube.isGreaterThen);
...
mat_filename = [imageLocation.anatomy(1:end-4), '_grid_info.mat'];
...
MRIwrite(gridImage, [imageLocation.anatomy(1:end-4), '_gridImage.nii']);
